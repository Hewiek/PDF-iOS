...
// 3. 导入图标库
import { Flame, Timer, Zap, Activity, Home, Files, Clock, PlusCircle, Wrench, Crown } from 'lucide-react';
...
const VAR_LIST: KeyDesc[] = [
    { name: 'currentTab', desc: '当前选中的标签页索引(0-4)' },
    ...
    return (
        <div className="demo-app-home-container" style={{ '--accent-color': accentColor } as any}>
            ...
            <div className="demo-app-home-header">
                ...
                <div className="demo-app-home-header-right">
                    <button className="demo-app-home-sub-btn">
                        <Crown size={16} />
                        <span>订阅</span>
                    </button>
            ...
            <div className="demo-app-home-tab-bar">
                ...
                >
                    ...
                    <div className="demo-app-home-tab-label">文件</div>
                </div>
                <div
                ...
                >
                    ...
                    <div className="demo-app-home-tab-label">最近</div>
                </div>
                <div
                ...
                >
                    ...
                    <div className="demo-app-home-tab-label">添加</div>
                </div>
                <div
                    className={'demo-app-home-tab-item ' + (currentTab === 4 ? 'active' : '')}
                    style={{ color: currentTab === 4 ? accentColor : undefined }}
                    onClick={function () { handleTabChange(4); }}
                >
                    <div className="demo-app-home-tab-icon">
                        <Wrench size={24} />
                    </div>
                    <div className="demo-app-home-tab-label">工具</div>
                </div>
            </div>
        </div>
    );
